...
void get_section(struct section_info* sc, struct touch_platform_data *pdata)
{
	...
	|| defined(CONFIG_MACH_MSM8926_VFP_KR) || defined(CONFIG_MACH_MSM8926_JAGNM_GLOBAL_COM) || defined(CONFIG_MACH_MSM8926_JAGNM_KDDI_JP) \
	|| defined(CONFIG_MACH_MSM8926_JAGDSNM_CN) || defined(CONFIG_MACH_MSM8926_AKA_KR)// to avoid division by zero in kernel
