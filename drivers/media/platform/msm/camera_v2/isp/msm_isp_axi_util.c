			...
			enum msm_isp_camif_update_state camif_update)
{
	...
	if (cur_stream_cnt == 0) {
		vfe_dev->ignore_error = 1;		/*QMC_PATCH, Fix false error detecting, 2014-02-27, jinw.kim@lge.com*/
		...
		vfe_dev->ignore_error = 0;		/*QMC_PATCH, Fix false error detecting, 2014-02-27, jinw.kim@lge.com*/
	}
