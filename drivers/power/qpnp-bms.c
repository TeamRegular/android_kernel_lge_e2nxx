...
static int set_battery_data(struct qpnp_bms_chip *chip)
{
	...
	switch ( battery_id ){
		...
		case BATT_ID_RA4301_VC1 :
			...
			pr_err("[BATTERY PROFILE] Using profile - LGE_BL41A1H_2100mAh_LG_Chem_data SW3800_VC0, RA4301_VC1 2100mAh for id(%d)\n",battery_id);
			break;
		case BATT_ID_RA4301_VC0 :
		case BATT_ID_SW3800_VC1 :
			batt_data = &LGE_BL41A1H_2100mAh_TOCAD_data;
			pr_err("[BATTERY PROFILE] Using profile - LGE_BL41A1H_2100mAh_TOCAD_data SW3800_VC1, RA4301_VC0 2100mAh for id(%d)\n",battery_id);
			break;
		case BATT_ID_RA4301_VC2 :
		case BATT_ID_SW3800_VC2 :
			batt_data = &LGE_BL41A1H_2100mAh_LG_Chem_data;
			pr_err("[BATTERY PROFILE] Using default profile - LGE_BL41A1H_2100mAh_LG_Chem_data for id(%d)\n",battery_id);
			break;
#endif
		case BATT_ID_ISL6296_C : // FALL THROUGH
		default :
