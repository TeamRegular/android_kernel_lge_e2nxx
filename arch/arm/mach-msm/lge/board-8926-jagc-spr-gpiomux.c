...
static int gpio_reserved_pin_rev_A[] = {
	0, 1, 2, 3, 5, 34, 35, 53, 54, 55, 60, 67, 73, 74, 76, 77, 78, 82, 83, 84, 89, 90, 94, 95, 96, 97, 98, 103, 104, 107, 112, 115, 116, 117, 118,
	MSM8x26_GPIO_END // This is included to notify the end of reserved GPIO configuration.
};
...
static struct msm_gpiomux_config wcnss_5wire_interface_B[] = {
	{
		.gpio = 39,		/* WLAN_SDIO3 */
		.settings = {
			[GPIOMUX_ACTIVE]    = &wcnss_5wire_active_cfg,
...
/*  LGE_CHANGE_E, [NFC][minwoo.kwon@lge.com], NFC Bring up */
	...
	if (hw_rev == HW_REV_A)
		...
		msm_gpiomux_install(wcnss_5wire_interface_B,
					ARRAY_SIZE(wcnss_5wire_interface_B));
#endif
