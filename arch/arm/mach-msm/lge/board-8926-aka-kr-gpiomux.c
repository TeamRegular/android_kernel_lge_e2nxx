...
//Need to set GPIO[060] DSV_ENN
//Need to set GPIO[111] DSV_ENP
...
static struct gpiomux_setting auth_pullup_act_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};
static struct gpiomux_setting auth_pullup_sus_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
};
static struct msm_gpiomux_config auth_pullup_configs[] __initdata = {
	{
		.gpio = 53,
		.settings = {
			[GPIOMUX_SUSPENDED] = &auth_pullup_sus_cfg,
			[GPIOMUX_ACTIVE] = &auth_pullup_act_cfg,
		},
	},
};


static struct gpiomux_setting auth_det_act_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_UP,
	.dir = GPIOMUX_IN,
};
static struct gpiomux_setting auth_det_sus_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_IN,
};
static struct msm_gpiomux_config auth_det_configs[] __initdata = {
	{
		.gpio = 67,
		.settings = {
			[GPIOMUX_SUSPENDED] = &auth_det_sus_cfg,
			[GPIOMUX_ACTIVE] = &auth_det_act_cfg,
		},
	},
};
...
/*  LGE_CHANGE_E, [NFC][garam.kim@lge.com], NFC Bring up */
	...
	msm_gpiomux_install(auth_det_configs, ARRAY_SIZE(auth_det_configs));
