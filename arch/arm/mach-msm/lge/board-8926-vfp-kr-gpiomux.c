...
/* LP5521 LED */
static struct gpiomux_setting gpio_led_act_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_4MA,
	.pull = GPIOMUX_PULL_UP,
...
static struct gpiomux_setting gpio_led_sus_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
	.dir = GPIOMUX_OUT_HIGH,
...
static struct msm_gpiomux_config msm_i2c_configs[] __initdata = {
	...
	},
	{
		.gpio      = 55,	/* LP5521 LED */
		.settings = {
			[GPIOMUX_ACTIVE] = &gpio_led_act_config,
			[GPIOMUX_SUSPENDED] = &gpio_led_sus_config,
		},
	},
	{
		.gpio      = 63,		/* FM_I2S_CLK */
