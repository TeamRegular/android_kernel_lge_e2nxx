...
static int gpio_reserved_pin_rev_10[] = {
	0, 1, 2, 4, 5, 10, 11, 12, 13, 14, 15, 20, 21, 22, 24, 33, 34, 35, 49, 50, 51, 52, 53, 54, 55, 56, 63, 65, 67, 73, 74, 78, 79, 80, 81, 82, 85, 86, 88, 89, 90, 91, 92, 94, 95, 96, 97, 98, 103, 104, 108, 109, 111, 116, 117, 118,
	MSM8x26_GPIO_END // This is included to notify the end of reserved GPIO configuration.
};
