...
static int gpio_reserved_pin_rev_A[] = {
	0, 1, 2, 3, 34, 53, 55, 56, 60, 75, 76, 77, 78, 79, 82, 91, 92, 93, 94, 97, 98, 104, 107, 112, 116, 117, 118,
	MSM8x26_GPIO_END // This is included to notify the end of reserved GPIO configuration.
	};
/*
...
static int gpio_reserved_pin_rev_B[] = {
	0, 1, 2, 3, 34, 53, 55, 56, 75, 76, 77, 78, 79, 82, 91, 92, 93, 94, 97, 98, 104, 110, 111, 112, 116, 117, 118,
	MSM8x26_GPIO_END // This is included to notify the end of reserved GPIO configuration.
	};
...
static struct gpiomux_setting wcnss_5wire_clk_active_cfg = {
	.func = GPIOMUX_FUNC_2,
	.drv  = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting wcnss_5wire_wakeup_act_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv  = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting wcnss_5wire_wakeup_sus_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv  = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct msm_gpiomux_config wcnss_5wire_interface_zero[] = {
	{
		.gpio = 39,		/* WLAN_SDIO3 */
		.settings = {
	...
	},
	{
		.gpio = 44,		/* WLAN_CLK */
		.settings = {
			[GPIOMUX_ACTIVE]    = &wcnss_5wire_clk_active_cfg,
			[GPIOMUX_SUSPENDED] = &wcnss_5wire_suspend_cfg,
		},
	},
	{
		.gpio = 56,		/* WLAN_HOST_WAKEUP */
		.settings = {
			[GPIOMUX_ACTIVE]    = &wcnss_5wire_wakeup_act_cfg,
			[GPIOMUX_SUSPENDED] = &wcnss_5wire_wakeup_sus_cfg,
		},
	},
};

static struct msm_gpiomux_config wcnss_5wire_interface_A[] = {
	{
		.gpio = 39,		/* WLAN_SDIO3 */
		.settings = {
			[GPIOMUX_ACTIVE]    = &wcnss_5wire_active_cfg,
