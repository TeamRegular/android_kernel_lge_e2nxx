...
static int gpio_reserved_pin_rev_A[] = {
	0, 1, 2, 3, 5, 12, 13, 20, 21, 22, 24, 32, 34, 35, 38, 45, 46, 49, 51, 52, 53, 55, 66, 77, 78, 82, 90, 91, 92, 93, 95, 96, 97, 98, 104, 109, 118, 119, 120,
	MSM8x26_GPIO_END // This is included to notify the end of reserved GPIO configuration.
	};
// Rev A +77,+91,+92,+93,-81,-89,-115,-116,-117
static int gpio_reserved_pin_rev_B[] = {
	0, 1, 2, 5, 12, 13, 20, 21, 22, 24, 32, 34, 35, 38, 45, 46, 49, 51, 52, 53, 55, 66, 73, 74, 77, 78, 79, 80, 82, 83, 84, 85, 86, 88, 89, 90, 91, 92, 93, 95, 96, 97, 98, 104, 109, 119, 120,
	MSM8x26_GPIO_END // This is included to notify the end of reserved GPIO configuration.
	};
// Rev B +73, +74, +79, +80, +83, +84, +85, +86, +88, +89, -3,-118
static int gpio_reserved_pin_rev_10[] = {
	0, 1, 2, 5, 12, 13, 20, 21, 22, 24, 32, 34, 35, 38, 45, 46, 49, 50, 51, 52, 53, 55, 66, 73, 74, 77, 78, 79, 80, 82, 83, 84, 85, 86, 88, 89, 90, 91, 92, 93, 95, 96, 97, 98, 104, 107, 109, 119, 120,
	MSM8x26_GPIO_END // This is included to notify the end of reserved GPIO configuration.
	};
// Rev 1.0 +50,+73, +74, +79, +80, +83, +84, +85, +86, +88, +89, +107, -3,-118
...
void __init msm8226_init_gpiomux(void)
{
	...
	if(hw_rev == HW_REV_0) {
		...
		printk(KERN_ERR " [Touch] HW_REV above A for Atmel Touch IC \n");

	} else {
                msm_gpiomux_install(msm_atmel_configs_rev_B, ARRAY_SIZE(msm_atmel_configs_rev_B));
                printk(KERN_ERR " [Touch] HW_REV above B for Atmel Touch IC \n");
